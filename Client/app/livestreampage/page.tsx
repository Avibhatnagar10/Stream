...
const Page = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  h-screen overflow-y-hidden text-white bg-gray-900 p-4">
      ...
      <div className="relative w-full max-w-4xl mb-4">
        <div
          className="theater-mode relative w-full h-0"
          style={{ paddingBottom: "56.25%" }}
        >
          <video
            ref={videoRef}
            className="absolute top-0 left-0 w-full h-full rounded-lg shadow-lg border-4 border-blue-500 animate-zoom-in"
            autoPlay
            muted
          />
        </div>
